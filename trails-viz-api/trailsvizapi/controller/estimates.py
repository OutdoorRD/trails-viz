...
@app.route('/api/sites/<string:siteid>/monthlyEstimates')
def get_monthly_estimates(siteid):
    data = estimates.get_monthly_estimates(siteid)
    return Response(data.to_json(orient='records'), mimetype='application/json')


@app.route('/api/sites/<string:siteid>/annualEstimates')
...
@app.route('/api/projects/<string:project>/lastYearEstimates')
def get_last_year_estimates(project):
    data = estimates.get_project_last_year_estimates(project)
    return Response(data.to_json(orient='records'), mimetype='application/json')
